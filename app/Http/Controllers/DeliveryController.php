    ...
    public function messages($page = 1, $limit = 15, $search = '') {
        ...
        if ($search) {
            ...
            $query = $query->where(function ($q) use ($search) {
                $q->where('subject', 'like', '%' . $search . '%')->orWhere('subject', 'like', '%' . $search . '%')->orWhere('subject', 'like', '%' . $search . '%');
            });
        }
