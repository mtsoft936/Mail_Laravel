...
class App extends Component {
    ...
    public function fetch() {
        try {
            ...
            $responses = [];
            if (env('BETA_FEATURE', false) || config('app.settings.engine') == 'delivery' || !config('app.settings.imap.cc_check', false)) {
                $responses = [
            ...
            if (!env('BETA_FEATURE', false) && config('app.settings.engine') != 'delivery') {
