...
} elseif ($_instance->childHasBeenRendered('55dYBJP')) {
    $componentId = $_instance->getRenderedChildComponentId('55dYBJP');
    $componentTag = $_instance->getRenderedChildComponentTagName('55dYBJP');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('55dYBJP');
} else {
    $response = \Livewire\Livewire::mount('navigation-dropdown');
    $html = $response->html();
    $_instance->logRenderedChild('55dYBJP', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
            ...
            <!-- Page Content -->
            <main>
                <div class="mt-5 -mb-5 hidden annoucements" data-id="5">
                        ...
                        <div class="col-span-6">
                            <div class="w-full py-3 px-4 overflow-hidden sm:rounded-md flex items-center border bg-indigo-50 border-indigo-500">
                                ...
                                <div class="ml-4 flex-1">
                                    ...
                                    <div class="text-md">
                                        <?php echo e(__('TMail 6.9 comes with ')); ?> <strong><?php echo e(__('Ad Block Detector')); ?></strong> - 
                                        <a class="font-medium underline" href="<?php echo e(route('settings')); ?>#ad-block-detector"><?php echo e(__('Try Now')); ?></a>
                                    </div>
                                </div>
...
<?php /**PATH /home/tmailcpuser95/public_html/resources/views/layouts/app.blade.php ENDPATH**/ ?>