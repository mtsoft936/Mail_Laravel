    ...
    <div id="imap-error" class="flex items-center w-full h-full fixed top-0 left-0 bg-red-900 opacity-75 z-50">
        <div class="flex flex-col mx-auto">
            ...
            <div class="p-2 mx-auto bg-red-800 text-white leading-none flex lg:inline-flex" role="alert">
                <span class="flex bg-red-500 uppercase px-2 py-1 text-xs font-bold mr-3"><?php echo e(__('Error')); ?></span>
        ...
        <?php if($messages): ?>
            <div class="mailbox">
                <div x-show="!show" class="list">
                    <div class="head flex items-center gap-3 pt-5 pb-6 px-7 text-white" style="background-color: <?php echo e(config('app.settings.colors.primary')); ?>">
                    ...
                    <div class="messages flex flex-col-reverse justify-end min-h-tm-mantis-message">
                ...
                <div x-show="show" class="message">
                    <div class="head flex items-center text-white py-5 px-7" style="background-color: <?php echo e(config('app.settings.colors.primary')); ?>">
...
</main><?php /**PATH /home/tmailcpuser95/public_html/resources/views/themes/mantis/components/app.blade.php ENDPATH**/ ?>