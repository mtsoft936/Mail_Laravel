...
} elseif ($_instance->childHasBeenRendered('qjDTYnj')) {
    $componentId = $_instance->getRenderedChildComponentId('qjDTYnj');
    $componentTag = $_instance->getRenderedChildComponentTagName('qjDTYnj');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('qjDTYnj');
} else {
    $response = \Livewire\Livewire::mount('frontend.actions', ['in_app' => isset($page) ? true : false]);
    $html = $response->html();
    $_instance->logRenderedChild('qjDTYnj', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
} elseif ($_instance->childHasBeenRendered('wmt2JZ3')) {
    $componentId = $_instance->getRenderedChildComponentId('wmt2JZ3');
    $componentTag = $_instance->getRenderedChildComponentTagName('wmt2JZ3');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('wmt2JZ3');
} else {
    $response = \Livewire\Livewire::mount('frontend.page', ['page' => $page]);
    $html = $response->html();
    $_instance->logRenderedChild('wmt2JZ3', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
                <?php else: ?>
...
} elseif ($_instance->childHasBeenRendered('Xcefc5U')) {
    $componentId = $_instance->getRenderedChildComponentId('Xcefc5U');
    $componentTag = $_instance->getRenderedChildComponentTagName('Xcefc5U');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('Xcefc5U');
} else {
    $response = \Livewire\Livewire::mount('frontend.app');
    $html = $response->html();
    $_instance->logRenderedChild('Xcefc5U', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
                <?php endif; ?>
...
} elseif ($_instance->childHasBeenRendered('Pux3jHU')) {
    $componentId = $_instance->getRenderedChildComponentId('Pux3jHU');
    $componentTag = $_instance->getRenderedChildComponentTagName('Pux3jHU');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('Pux3jHU');
} else {
    $response = \Livewire\Livewire::mount('frontend.nav');
    $html = $response->html();
    $_instance->logRenderedChild('Pux3jHU', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
                </div>
...
<?php /**PATH /home/tmailcpuser95/public_html/resources/views/themes/groot/app.blade.php ENDPATH**/ ?>