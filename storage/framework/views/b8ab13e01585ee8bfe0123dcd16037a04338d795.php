...
<?php endif; ?>
                <?php endif; ?>
                <input class="block appearance-none w-full border-0 rounded-md py-4 px-5 bg-white text-white bg-opacity-10 focus:outline-none placeholder-white placeholder-opacity-30" type="text" id="user" name="user" wire:model.defer="user" placeholder="<?php echo e(__('Enter Username')); ?>">
...
<?php endif; ?>
    ...
    <?php endif; ?>
</div><?php /**PATH /home/admin/domains/tmail.io/public_html/resources/views/themes/nebula/components/actions.blade.php ENDPATH**/ ?>