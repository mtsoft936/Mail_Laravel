                    ...
                    <div class="flex items-baseline space-x-4">
                        <?php $__currentLoopData = $menus; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $menu): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            ...
                            <div @click.away="open = false" class="relative" x-data="{ open: false }">
                                ...
                                <div x-show="open" x-transition:enter="transition ease-out duration-100" x-transition:enter-start="transform opacity-0 scale-95" x-transition:enter-end="transform opacity-100 scale-100" x-transition:leave="transition ease-in duration-75" x-transition:leave-start="transform opacity-100 scale-100" x-transition:leave-end="transform opacity-0 scale-95" class="absolute left-0 w-full mt-2 origin-top-right rounded-md shadow-lg md:w-48">
                                    <div class="px-2 py-2 bg-white rounded-lg shadow dark-mode:bg-gray-800">
                                        ...
                                        <a class="block px-4 py-2 mt-2 text-sm font-semibold bg-transparent rounded-lg text-gray-700 md:mt-0 hover:text-gray-900 focus:text-gray-900 hover:bg-gray-100 focus:bg-gray-100 focus:outline-none" href="<?php echo e($child->link); ?>" target="<?php echo e($child->target); ?>"><?php echo e(__($child->name)); ?></a>
                            ...
                            <?php else: ?>
                                ...
                                <a href="<?php echo e($menu->link); ?>" class="px-3 py-2 text-sm font-semibold text-left bg-transparent text-gray-700 <?php echo e(url()->current() === $menu->link ? 'bg-gray-200' : ''); ?> rounded-lg md:w-auto md:inline hover:text-gray-900 focus:text-gray-900 hover:bg-gray-200 focus:bg-gray-200 focus:outline-none" target="<?php echo e($menu->target); ?>"><?php echo e(__($menu->name)); ?></a>
                                <?php endif; ?>
                            <?php endif; ?>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        <?php if(Auth::check() && Auth::user()->role == 7): ?>
                            <a href="<?php echo e(route('admin')); ?>" class="px-3 py-2 text-sm font-semibold text-left bg-transparent border-dashed border-2 border-red-700 text-red-700 rounded-lg md:w-auto md:inline hover:bg-red-100"><?php echo e(__('Admin')); ?></a>
                        <?php endif; ?>
                    </div>
                </div>
                <div class="flex items-center">
...
</nav><?php /**PATH /home/tmailcpuser95/public_html/resources/views/themes/default/components/nav.blade.php ENDPATH**/ ?>