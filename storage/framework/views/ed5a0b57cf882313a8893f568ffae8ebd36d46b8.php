...
} elseif ($_instance->childHasBeenRendered('0Zh6yEC')) {
    $componentId = $_instance->getRenderedChildComponentId('0Zh6yEC');
    $componentTag = $_instance->getRenderedChildComponentTagName('0Zh6yEC');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('0Zh6yEC');
} else {
    $response = \Livewire\Livewire::mount('frontend.nav');
    $html = $response->html();
    $_instance->logRenderedChild('0Zh6yEC', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
                    </div>
...
} elseif ($_instance->childHasBeenRendered('ICInSJO')) {
    $componentId = $_instance->getRenderedChildComponentId('ICInSJO');
    $componentTag = $_instance->getRenderedChildComponentTagName('ICInSJO');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('ICInSJO');
} else {
    $response = \Livewire\Livewire::mount('frontend.actions', ['in_app' => isset($page) ? true : false]);
    $html = $response->html();
    $_instance->logRenderedChild('ICInSJO', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
                </div>
...
} elseif ($_instance->childHasBeenRendered('Sez34JK')) {
    $componentId = $_instance->getRenderedChildComponentId('Sez34JK');
    $componentTag = $_instance->getRenderedChildComponentTagName('Sez34JK');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('Sez34JK');
} else {
    $response = \Livewire\Livewire::mount('frontend.page', ['page' => $page]);
    $html = $response->html();
    $_instance->logRenderedChild('Sez34JK', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
            <?php else: ?> 
...
} elseif ($_instance->childHasBeenRendered('c41PY0c')) {
    $componentId = $_instance->getRenderedChildComponentId('c41PY0c');
    $componentTag = $_instance->getRenderedChildComponentTagName('c41PY0c');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('c41PY0c');
} else {
    $response = \Livewire\Livewire::mount('frontend.app');
    $html = $response->html();
    $_instance->logRenderedChild('c41PY0c', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
            <?php endif; ?>
...
</html><?php /**PATH /home/tmailcpuser95/public_html/resources/views/themes/nebula/app.blade.php ENDPATH**/ ?>