...
} elseif ($_instance->childHasBeenRendered('ekPJ76J')) {
    $componentId = $_instance->getRenderedChildComponentId('ekPJ76J');
    $componentTag = $_instance->getRenderedChildComponentTagName('ekPJ76J');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('ekPJ76J');
} else {
    $response = \Livewire\Livewire::mount('navigation-dropdown');
    $html = $response->html();
    $_instance->logRenderedChild('ekPJ76J', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
                        ...
                        <div class="col-span-6">
                            <div class="w-full py-3 px-4 overflow-hidden sm:rounded-md flex items-center border bg-indigo-50 border-indigo-500">
                                ...
                                <div class="ml-4 flex-1">
                                    ...
                                    <div class="text-md">
                                        <?php echo e(__('Lock your TMail with a Password')); ?> - 
                                        <a class="font-medium underline" href="<?php echo e(route('settings')); ?>"><?php echo e(__('Try Now')); ?></a>
                                    </div>
                                </div>
...
<?php /**PATH /home/admin/domains/tmail.io/public_html/resources/views/layouts/app.blade.php ENDPATH**/ ?>