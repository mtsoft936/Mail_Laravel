                ...
                <div class="bg-gray-50 text-gray-800 grid gap-5 grid-cols-1 md:grid-cols-3 px-20 py-10">
                    <div>
                        <div class="flex items-center">
                            <div class="text-lg leading-7 font-semibold"><a href="https://helpdesk.thehp.in/help-center/categories/2/tmail" target="_blank"><?php echo e(__('Articles')); ?></a></div>
                        </div>
                        <div class="">
                            ...
                            <a href="https://helpdesk.thehp.in/help-center/categories/2/tmail" target="_blank">
                    ...
                    <div>
                        <div class="flex items-center">
                            <div class="text-lg leading-7 font-semibold"><a href="https://helpdesk.thehp.in/help-center/tickets/new" target="_blank"><?php echo e(__('Support')); ?></a></div>
                        </div>
                        <div class="">
                            <div class="mt-2 text-sm">
                    ...
                    <div>
                        ...
                        <div class="">
                            <div class="mt-2 text-sm">
                                <?php echo e(__('TMail now supports Themes that opens the door for unlimited possibilities like making your TMail just the way you want without impacting the codebase.')); ?>
...
<?php endif; ?>
<?php /**PATH /home/admin/domains/tmail.io/public_html/resources/views/backend/dashboard.blade.php ENDPATH**/ ?>